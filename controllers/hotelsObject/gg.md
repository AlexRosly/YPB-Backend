...
1.  Добавить международное название района при создании страницы
2.  создать маршрут + контроллер для поиска по языку, описанию и международное название района
