...
Треба ендпоінт який буде відображати дані з БД:

1. скіки обєктів на верифікації (по деф 0). - done
2. Кілкіст: юзерів, отелєрів, агентів (коли аккаунт активний, коли видалений - то тут не відображаємо) - done
3. Число доданий на сервіс обєктів - які мают статус верифікований. - done
4. Число варіантів бронювання у верифікованих обєктах (по дефолту 0 постав поки) ДЯКУЮ - done

Check delete hotelier, user, agent

До варіфнтів бронювань треба додати значення коли обєкт на веріфікації або активний

1. Додати в додавання бонусів зміну статусу.
   коли -20,01 тоді не активний, якщо -20,00 або більше тоді активний
